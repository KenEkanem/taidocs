...
<CardGroup>
  <Card title="Learn more about NINProfile" icon="id-badge" href="/docs/products/ninprofile">
    Detailed features, setup, and usage guides.
  </Card>
  <Card title="How to get started" icon="user-plus" href="docs/auth">
...
<Card title="Explore NINComply" icon="shield-check" href="/docs/products/nincomply">
...
<Card title="Discover ReferenceMe" icon="user-group" 
href="/docs/products/referenceme">
...
<Card title="Understanding E-Signatures" icon="signature" href="/docs/products/e-signatures">
...
<Card title="NIN-Based Surveillance" icon="eye" href="/docs/products/nin-based-surveillance">
